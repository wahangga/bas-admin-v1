  ...
  return <div className="position-relative ps-4">
      <div className="mb-4">
        ...
        'avatar-sm': !icon
          ...
          {icon ? <Image src={icon} height={36} width={36} alt="avatar" className="avatar-sm rounded-circle" /> : type ? <IconifyIcon icon={getActivityIcon(type)} /> : title.charAt(0).toUpperCase()}
        </span>
        <div className="ms-2">
