...
export const getActivityIcon = type => {
  if (type === 'tasks') return 'iconamoon:folder-check-duotone';else if (type === 'design') return 'iconamoon:check-circle-1-duotone';else return 'iconamoon:certificate-badge-duotone';
};